...
**Full Endpoint**: `GET http://your-domain/api/v1/superadmin/revoked-users` (pending)
...
---
### 2.5 project processing 
**Full Endpoint**:`POST http://localhost/api/v1/rfp-projects/18/start-complete-processing`
**Purpose**: get started project  
**Authentication**: Required (ADMIN role)
**Response (Success - 200)**:
```json
{
    "success": true,
    "message": "Complete RFP processing and proposal generation started",
    "project_id": 18,
    "task_id": "94249052-e9b9-4c2a-a454-473bd35f0d6f",
    "status": "queued",
    "estimated_time": "This may take several minutes. You will receive an email notification when complete."
}
```
**Request Headers**:
```
